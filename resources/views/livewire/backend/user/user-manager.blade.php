<div>
                        ...
                        <tr class="table-tr">
                            ...
                            <td class="table-td text-right">
                                <div class="flex items-center justify-end gap-2">
                                    ...
                                    <x-buttons.button wire:click="confirmDelete({{ $user->id }})" variant="danger"
        ...
        <x-modal.modal>
            ...
            <div class="space-y-4">
                ...
                <div class="border-t pt-4">
                    ...
                    <p class="mt-1 text-sm text-gray-500">Hold Ctrl (Windows) or Command (Mac) to select multiple
                        roles.
                    </p>
                    @error('selectedRoles')
                        <span class="text-red-500 text-xs">{{ $message }}</span>
                ...
                @else
                    <div class="border-t pt-4">
                        <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-3">Change Password (Optional)
                        </h3>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="space-y-1">
    ...
    <x-modals.confirm-delete modal-trigger="confirmingDelete" title="Delete User"
        content="Are you sure you want to delete this user? This action cannot be undone."
        confirm-button-text="Delete" cancel-button-text="Cancel" wire-click="delete" />
</div>
